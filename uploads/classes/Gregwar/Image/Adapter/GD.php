...
namespace Diveramkt\Uploads\Classes\Gregwar\Image\Adapter;

use Diveramkt\Uploads\Classes\Gregwar\Image\Image;
use Diveramkt\Uploads\Classes\Gregwar\Image\ImageColor;

include 'plugins/diveramkt/uploads/classes/Gregwar/Image/Adapter/Common.php';
include 'plugins/diveramkt/uploads/classes/Gregwar/Image/ImageColor.php';
...
class GD extends Common
{
    ...
    public function opacity($opacity=100)
    {
    ...
    //loop through image pixels and modify alpha for each
        for ($x = 0; $x < $w; $x++) {
            ...
            //get current alpha value (represents the TANSPARENCY!)
                $colorxy = imagecolorat($this->resource, $x, $y);
            ...
            //get the color index with new alpha
                $alphacolorxy = imagecolorallocatealpha($this->resource, ($colorxy >> 16) & 0xFF, ($colorxy >> 8) & 0xFF, $colorxy & 0xFF, $alpha);
            //set pixel with the new color + opacity
                if (!imagesetpixel($this->resource, $x, $y, $alphacolorxy)) {
                    return $this;
                }
            }
        }
