...
include 'plugins/diveramkt/uploads/classes/Gregwar/Image/Adapter/Adapter.php';
...
abstract class Common extends Adapter
{
    ...
    public function init()
    {
        ...
        if ($source instanceof \Diveramkt\Uploads\Classes\Gregwar\Image\Source\File) {
            $this->loadFile($source->getFile(), $source->guessType());
        } elseif ($source instanceof \Diveramkt\Uploads\Classes\Gregwar\Image\Source\Create) {
            $this->createImage($source->getWidth(), $source->getHeight());
        } elseif ($source instanceof \Diveramkt\Uploads\Classes\Gregwar\Image\Source\Data) {
            $this->createImageFromData($source->getData());
        } elseif ($source instanceof \Diveramkt\Uploads\Classes\Gregwar\Image\Source\Resource) {
