 ...
 +function ($) { "use strict";
    ...
    FileUpload.prototype.init = function() {
        if (this.options.isMulti === null) {
            ...
            if(this.$el.data('limit') != undefined){
                this.options.maxFiles=parseInt(this.$el.data('limit'));
            }            
        }
    ...
    FileUpload.prototype.bindUploader = function() {
        var dictMaxFilesExceeded='You can not upload any more files.';
        if(this.$el.data('limit-message') != undefined) dictMaxFilesExceeded=this.$el.data('limit-message');
        this.uploaderOptions = {
            ...
            maxFiles: !this.options.isMulti ? 1 : this.options.maxFiles,
            headers: {},
